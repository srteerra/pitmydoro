...
const url = 'https://www.pitmydoro.com/learn';
...
export default async function LearnLayout({ children }: { children: React.ReactNode }) {
  ...
  const jsonLd = {
    ...
    description: t('description'),
    inLanguage: locale,
    image: 'https://www.pitmydoro.com/images/cover.png',
    mainEntityOfPage: { '@type': 'WebPage', '@id': url },
    author: { '@type': 'Organization', name: 'Pit My Doro' },
    publisher: {
      '@type': 'Organization',
      name: 'Pit My Doro',
      logo: { '@type': 'ImageObject', url: 'https://www.pitmydoro.com/images/cover.png' },
    },
  };
