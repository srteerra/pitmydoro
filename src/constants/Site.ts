...
export const SITE_URL = 'https://www.pitmydoro.com';

export const SITE_NAME = 'Pitmydoro';

export const APP_VERSION = packageJson.version;

export const GITHUB_PROFILE_URL = 'https://github.com/srteerra';

export const GITHUB_REPO_URL = 'https://github.com/srteerra/pitmydoro';
...
export const DATA_DELETION_DAYS = 15;
